...
tok_t t_basic[] = {
	...
	{ 0x38, NONE, "8" },
	{ 0x39, NONE, "9" },
	{ 0x3A, NONE, ".", true }, /* safe to prevent ... from being made an ellipsis char */
	{ 0x3B, NONE, "|E" },
	{ 0x3C, NONE, " or " },
	{ 0x3D, NONE, " xor " },
	{ 0x3E, NONE, ":" },
	...
	{ 0x6F, NONE, "!=" },
	{ 0x70, NONE, "+" },
	{ 0x71, NONE, "-", true }, /* safe to allow typing -> rather than → */
	{ 0x72, NONE, "Ans" },
	{ 0x73, NONE, "Fix " },
	{ 0x74, NONE, "Horiz" },
	{ 0x75, NONE, "Full" },
...
tok_t t_axe[] = {
	...
	{ 0xBB, 0x2E, "RectI(" },
	{ 0xBB, 0x2F, ">Hex" },
	{ 0xBB, 0x31, "[e]" }, /* euler's constant e */
	{ 0xBB, 0x32, "Freq(" },
	{ 0xBB, 0x35, "rotC(" },
	{ 0xBB, 0x36, "rotCC(" },
	{ 0xBB, 0x37, "flipV(" },
